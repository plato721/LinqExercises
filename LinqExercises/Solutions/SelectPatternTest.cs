...
public class SelectPatternTest
{
  ...
  public void Capitalize()
  {
    ...
    {
      var capitalizedName = name.Substring(0, 1).ToUpper() + name.Substring(1); 
  ...
  public void Backwards()
  {
    ...
    foreach (var name in names)
    {
      backwards.Add(name.Reverse().ToString());
    }
  ...
  public void WordsWithNoVowels()
  {
    ...
    {
      var transformedWord = Regex.Replace(word, "[aeiou]", "");
      withoutVowels.Add(transformedWord);
    }
  ...
  public void TrimLastLetter()
  {
    ...
    {
      trimmed.Add(animal.Substring(0, animal.Length - 1));
    }
