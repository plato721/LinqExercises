...
public class GroupByTest
{
  ...
  public void GroupWordsByFirstLetter()
  {
    ...
    var wordsByFirstLettter = words.GroupBy(w => w.First()).ToList();
  ...
  public void GroupByNumberOfZeros()
  {
    ...
    var grouped = numbers.GroupBy(n => Convert.ToString(n).Count(n => n == '0'))
      .ToList();
  ...
  public void GroupByOrderOfMagnitude()
  {
    ...
    var grouped = numbers.GroupBy(n => Convert.ToString(n).Length)
      .ToList();
